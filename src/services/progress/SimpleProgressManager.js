...
/**
 * Простой менеджер прогресса, который всегда использует localStorage
 * Это решает проблемы с циклическими импортами и ошибками Blobs
 */
export class SimpleProgressManager {
  constructor() {
  ...
  async initialize() {
    ...
    try {
      ...
      console.log('✅ SimpleProgressManager инициализирован с localStorage');
    } catch (error) {
      console.error('Ошибка инициализации SimpleProgressManager:', error);
      this.isInitialized = true;
    }
  }
